...
(function() {
  ...
  FV.FileMainView = Backbone.View.extend({
    ...
    render: function() {
      this.list.empty();
      this.pathHeader.html(this.path);
      this.fileList.each((function(_this) {
  ...
  $(document).ready(function() {
    ...
    $('html').keyup(function(e) {
      if (e.keyCode === FV.Constants.BACKSPACE_KEY && app.path !== '/') {
        return app.dirAjaxHandler(app.parentDir(app.path));
      }
    });
  });
